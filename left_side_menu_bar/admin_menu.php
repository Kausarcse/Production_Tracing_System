				...
				<ul class="sidebar-menu" data-widget="tree">
					  ...
					  <li class="treeview" id="settings_menu">
								...
								<ul class="treeview-menu">
								  ...
								  <li><a onClick="load_page('settings/process_name.php')"><i class="fa fa-circle-o"></i>Add Process</a></li>
					   ...
					   <li class="treeview" id="main_process_menu">
								...
								<ul class="treeview-menu">
								  ...
								  <!-- <li><a onClick="load_page('process/adding_process_route_for_po_rework.php')"><i class="fa fa-circle-o"></i>Adding Re-Work Route for PO</a></li> -->
								  ...
								  <!-- <li><a onClick="load_page('process/rework_wise_travel_card.php')"><i class="fa fa-circle-o"></i>Rework Wise Travel Card</a></li>  --> 
								<!--   <li><a onClick="load_page('process/rework_wise_travel_card.php')"><i class="fa fa-circle-o"></i>ReWork Wise Travel Card</a></li> -->  
								  <li><a onClick="load_page('process/today_transection_list.php')"><i class="fa fa-circle-o"></i>Today Transection</a></li>  
					  ...
					  <li class="treeview" id="list_menu">
								...
								<ul class="treeview-menu">
                                  ...
                                  <li><a onClick="load_page('list/po_list.php')"><i class="fa fa-circle-o"></i>PO List</a></li> 
                                  <li><a onClick="load_page('list/po_details_list.php')"><i class="fa fa-circle-o"></i>PO Details List</a></li> 
                                  <li><a onClick="load_page('list/travel_card_list.php')"><i class="fa fa-circle-o"></i>Travel Card List</a></li> 
                                  <li><a onClick="load_page('list/process_wise_travel_card_list.php')"><i class="fa fa-circle-o"></i>Process Wise Travel Card</a></li> 
					  ...
					  <li class="treeview" id="report_menu">
								...
								<ul class="treeview-menu">
								  ...
								  <li><a onClick="load_page('travel_card_report/po_wise_travel_card_report.php')"><i class="fa fa-circle-o"></i>PO Wise Report</a></li>   
								   ...
								   <li><a onClick="load_page('travel_card_report/summary_report.php')"><i class="fa fa-circle-o"></i>Summary Report</a></li>  
					  ...
					  <li class="treeview" id="main_product_menu">
								...
								<ul class="treeview-menu">
								  <!-- <li><a onClick="load_page('backup/database_backup.php')"><i class="fa fa-circle-o"></i>DB Backup</a></li> -->
								  <li><a onClick="database_backup()"><i class="fa fa-circle-o"></i>DB Backup</a></li>
								</ul> <!-- End of <ul class="treeview-menu"> -->
...
<script>
	function database_backup(){
		...
		$.ajax({
                    url: 'backup/database_backup.php',
                    dataType: 'text',
                    type: 'post',
                    ...
                    success: function( data, textStatus, jQxhr )
                    {
							...
							var download_url = 'backup/'+data;
							document.getElementById('backup_display').href = download_url;
