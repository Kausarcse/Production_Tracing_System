					  ...
					  <li><a href=""><i class="fa fa-dashboard"></i> <span>Dashboard</span> </a> </li>
					   ...
					   <li class="treeview" id="main_process_menu">
								...
								<ul class="treeview-menu">
								  ...
								  <li><a onClick="load_page('process/date_range_wise_transaction.php')"><i class="fa fa-circle-o"></i>Date Range Wise Transaction</a></li> 

								   <li><a onClick="load_page('process/pending_list.php')"><i class="fa fa-circle-o"></i>Pending List</a></li> 
