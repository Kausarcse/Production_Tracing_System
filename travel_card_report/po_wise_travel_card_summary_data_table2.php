           ...
           <table class="table table-bordered" style="border: 2px solid black;" id="table_for_result">
                    <thead>
                            ...
                            <tr style="background-color: #C0C0C0; border: 2px solid black;">
                                ...
                                <th colspan="4" style="border: 1px solid">Corrugation</th>

                                <th colspan="4" style="border: 1px solid">Printing & Slotting </th>

                                <th colspan="4" style="border: 1px solid">Cutting Creasing</th>

                                <th colspan="4" style="border: 1px solid">Die Cutting </th>

                                <th colspan="4" style="border: 1px solid">Manual Slotting</th>

                                <th colspan="4" style="border: 1px solid">Folding & Gluing</th>

                                <th colspan="4" style="border: 1px solid">Delivery</th>
         ...
         {        
            ...
            $product_delivery_date = date_format($date,"m/d/Y");
                             ...
                             $table.='
                                    ...
                                    <td style="border: 1px solid">'.$row['actual_ratio'].'</td>
                                    <td style="border: 1px solid">'.$row['actual_roll_size'].'</td> 
                    ...
                    //For Corrugation
                          ...
                          $sql_for_process_wise = "SELECT DISTINCT pn.process_id,tcdft.process_quantity,pd.carton_quantity,( pd.carton_quantity - tcdft.process_quantity) short_access,tcdft.recording_person_name From travel_card_details_for_transactions tcdft 
                        ...
                        if(mysqli_num_rows($result_for_process_wise)>0)
                        {
                             while( $row_for_process_wise = mysqli_fetch_array( $result_for_process_wise))
                                 {  
                                            $table.='<td style="border: 1px solid">'.$row_for_process_wise['recording_person_name'].'</td>
                                ...
                                {
                                     $table.='<td style="border: 1px solid">N/A</td>   <td style="border: 1px solid">N/A</td>
                    ...
                    // For Printing & Slotting
                         ...
                         if(mysqli_num_rows($result_for_process_wise)>0)
                        {
                             while( $row_for_process_wise = mysqli_fetch_array( $result_for_process_wise))
                                 {  
                                            $table.='<td style="border: 1px solid">'.$row_for_process_wise['recording_person_name'].'</td>      <td style="border: 1px solid">'.$row_for_process_wise['process_quantity'].'</td>
                                            <td style="border: 1px solid">'.$row_for_process_wise['short_access'].'</td>
                                            <td style="border: 1px solid">'.$row_for_process_wise['short_access'].'</td>';
                                 }
                        }
