...
function searching_for_po_summary(i)
{
	         var po_id= i;
			
		
            $.ajax({
			 		url: 'travel_card_report/returning_details_of_po.php',
			 		dataType: 'text',
			 		type: 'post',
			 		contentType: 'application/x-www-form-urlencoded',
			 		data: {po_id:po_id},
			 		...
			 		{       
                          ...
                          // alert(data);
			 				document.getElementById('details_based_on_po_div').innerHTML=data;
 ...
 <div class="col-sm-12 col-md-12 col-lg-12">
       <div class="panel panel-default">
       	   ...
       	   <div id="element_for_first_div">
                ...
                <div class="panel-heading" style="color:#191970;"><b>Report</b></div> <!-- This will create a upper block for FORM (Just Beautification) -->
                   ...
                   <form class="form-horizontal" action="" style="margin-top:10px;" name="travel_card_report_for" id="travel_card_report_for">
						...
						<div class="form-group form-group-sm" id="form-group_for_po_id" id="form_customized_report">
						<label class="control-label col-sm-4" for="po_id" style="margin-right:0px; color:#00008B;">PO:</label>
							<div class="col-sm-5">
								<select  class="form-control for_auto_complete" id="po_id" name="po_id" onchange="searching_for_po_summary(this.value)">
											<option select="selected" value="select">Select PO </option>
											<?php 
												 $sql = 'select po_id,po_number from `po_creation` order by row_id asc';
												 $result= mysqli_query($con,$sql) or die(mysqli_error());
												 while( $row = mysqli_fetch_array( $result))
												 {

													 echo '<option value="'.$row['po_id'].'">'.$row['po_number'].'</option>';
			 ...
			 <div id="element">
						...
						<div class="form-group form-group-sm"  id="details_based_on_po_div" >
						   
							<!-- This is Display Section. --> 

							<div id="details_based_on_po_div" class="col-sm-12" align="center" style=" margin-top:0px;"> </div>
