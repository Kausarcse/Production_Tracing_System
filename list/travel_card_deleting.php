...
mysqli_query($con,"START TRANSACTION") or die(mysqli_error($con));
	...
	$delete_sql_statement="DELETE FROM travel_card_details WHERE travel_card_id = '$travel_card_id'";
...
if($data_deleteion_hampering == "No" )
{
	...
	echo "Travel Card is successfully Deleted.";
...
else
{
	...
	echo "Travel Card is not successfully Deleted.";
