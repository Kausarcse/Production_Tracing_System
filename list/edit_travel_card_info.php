						...
						<div class="form-group form-group-sm" >
					      ...
					      <div class="col-sm-3 text-center">
					       ...
					       <div class="col-sm-1 text-center">
					                ...
					                <input class="form-control input-sm" type="text" id="liner_consumption_calc" name="liner_consumption_calc" value="<?php echo $row_for_travel_card['liner_consumption_calc']?>">
					           ...
					           <div class="col-sm-1 text-center">
					                <input class="form-control input-sm" type="text" id="media_consumption_calc" name="media_consumption_calc" value="<?php echo $row_for_travel_card['media_consumption_calc']?>" >
					             
					         </div>
					            
					             
					          <div class="col-sm-1 text-center">
					               <input class="form-control input-sm" type="text" id="sqm_consumption_calc" name="sqm_consumption_calc" value="<?php echo $row_for_travel_card['sqm_consumption_calc']?>" >
					          ...
					          <div class="col-sm-1" for="total_consumption">
                                     ...
                                     <input class="form-control input-sm" type="text" id="total_consumption" name="total_consumption" value="<?php echo $row_for_travel_card['total_consumption']?>" >
