            ...
            <?php 
             ...
             <tr>
                ...
                <td>
                       ...
                       <!-- <button type="submit" id="edit_po_details" name="edit_po_details"  class="btn btn-primary btn-xs" onclick="return_product_category_for_edit_po_details_list('<?php //echo $row['po_details_id'] ?>')"> Edit </button>
                       <span>  </span> -->
