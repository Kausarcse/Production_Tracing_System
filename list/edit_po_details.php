...
<nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        <li class="breadcrumb-item active" aria-current="page">Home</li>
         <li class="breadcrumb-item"><a onclick="load_page('process/po_details.php')">Edit PO Details</a></li>
      </ol>
 </nav>
...
<form class="form-horizontal" action="" style="margin-top:10px;" name="po_details_form" id="po_details_form">
    ...
    <input type="hidden" id="product_category" name="product_category" value="<?php echo $option?>"> 
        ...
        <div class="form-group form-group-sm" id="form-group_for_po_number">
            ...
            <label><span id="show"></span></label>
                ...
                <div class="col-sm-5">
                    <input class="form-control input-sm" type="text" id="po_number" name="po_number" value="<?php echo $row1['po_number'] ?>"> 
                 </div> 
          ...
          <div class="col-sm-3 text-center">
             <label class="control-label"  style="color:#00008B;"><span id="for_measurement_of_carton">Measurement of Carton</span> </label>
              ...
              <div class="col-sm-1 text-center">
               ...
               <div class="col-sm-1 text-center">
                    <input class="form-control input-sm" type="text" id="measurement_of_carton_width" name="measurement_of_carton_width" value="<?php echo $row1['measurement_of_carton_width'] ?>" onchange="calculate_width_wise_data_carton(this.value)">
                 
              </div>
                
                 
              <div class="col-sm-1 text-center">
                   <input class="form-control input-sm" type="text" id="measurement_of_cartoon_height" name="measurement_of_cartoon_height" value="<?php echo $row1['measurement_of_cartoon_height'] ?>" onchange="calculate_height_wise_data_carton()">
                    ...
                    <div class="form-group form-group-sm" >
                            ...
                            <div class="col-sm-3 text-center">
                             ...
                             <div class="col-sm-1 text-center">
                                    ...
                                    <input class="form-control input-sm" type="text" id="carton_quantity" name="carton_quantity"  value="<?php echo $row1['carton_quantity']?>" onchange="total_board_Quantity_carton(this.value)">
          ...
          <div class="col-sm-3 text-center">
             <label class="control-label"  style="color:#00008B;"><span id="for_measurement_of_carton">Measurement of Carton</span> </label>
              ...
              <div class="col-sm-1 text-center">
               ...
               <div class="col-sm-1 text-center">
                    <input class="form-control input-sm" type="text" id="measurement_of_carton_width" name="measurement_of_carton_width" value="<?php echo $row1['measurement_of_carton_width'] ?>" onchange="calculate_width_wise_data_all(this.value)">
                    ...
                    <div class="form-group form-group-sm">
                            ...
                            <div class="col-sm-3 text-center">
                             ...
                             <div class="col-sm-1 text-center">
                                    ...
                                    <input class="form-control input-sm" type="text" id="carton_quantity" name="carton_quantity"  value="<?php echo $row1['carton_quantity']?>" onchange="total_board_Quantity_all(this.value)">
                     ...
                     <div class="form-group form-group-sm" >
                            ...
                            <div class="col-sm-1 text-center">
                                ...
                                <input class="form-control input-sm" type="text" id="cutting_ratio" name="cutting_ratio" value="<?php echo $row1['cutting_ratio']?>" onchange="change_quantity_after_ratio_all(this.value)">
...
<!-- ---------------------------------All  Calculative script---------------------------- -->
     ...
     <!-- ---------------------------------All  Calculative script---------------------------- -->
      ...
      <script>
        ...
        function calculate_width_wise_data_carton(measurement_of_carton_width)
        {
          ...
          function calculate_height_wise_data_carton()
          {
        ...
        function total_board_Quantity_carton(carton_quantity){
          var carton_quantity= carton_quantity;
          var ratio= document.getElementById("ratio").value;

          console.log(carton_quantity);
        ...
        function calculate_width_wise_data_all(measurement_of_carton_width)
        {
        ...
        function total_board_Quantity_all(carton_quantity){
            var carton_quantity= carton_quantity;
            var ratio= document.getElementById("ratio").value;
        ...
        function change_quantity_after_ratio_all(cutting_ratio)
        {
