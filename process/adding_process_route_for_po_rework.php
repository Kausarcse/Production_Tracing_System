...
?>
<script type='text/javascript' src='process/adding_process_route_for_po_rework_form_validation.js'></script>
...
function adding_new_form_elements_in_process_adding_table(row_number)
{
	...
	table.rows[new_row_position].cells[3].innerHTML='<select  class="form-control" id="process_or_rework_'+new_possible_number_of_process+'" name="process_or_rework_'+new_possible_number_of_process+'">'
											+'<option value="process" select="selected">Process</option>'
											+'<option value="re-work" selected>re-work</option>'
								            +' </select>';
 ...
 function sending_data_of_adding_process_route_for_po_rework_form_for_saving_in_database()
 {

		
	   var validate = adding_process_route_for_po_rework_Form_Validation();


      var url_encoded_form_data = $("#adding_process_route_for_po_rework_form").serialize(); ///This will read all control elements value of the form
       ...
       if(validate != false)
	   {
		  	 ...
		  	 $.ajax({
			 		url: 'process/adding_process_route_for_po_rework_saving.php',
			 		dataType: 'text',
			 		type: 'post',
 ...
 }//End of function sending_data_of_adding_process_route_for_po_rework_form_for_saving_in_database()
 ...
 function sending_data_for_delete(value)
 {
       ...
       var url_encoded_form_data = 'process_id='+value;
		  	 ...
		  	 $.ajax({
			 		url: 'process/deleting_adding_process_route_for_po_rework.php',
			 		dataType: 'text',
			 		type: 'post',
			 		contentType: 'application/x-www-form-urlencoded',
			 		data: url_encoded_form_data,
  ...
  function sending_data_for_update(get_all_data)
 {
      ...
      var get_all_data=get_all_data;
       ...
       $('#div_full_form').load("process/edit_adding_process_route_for_po_rework.php?update_value="+encodeURIComponent(get_all_data));
...
<div class="col-sm-12 col-md-12 col-lg-12">
    ...
    <div id="div_full_form">
		<div class="panel panel-default"> <!-- This div will create a block/panel for FORM -->
				...
				<nav aria-label="breadcrumb">
						  <ol class="breadcrumb">
						    ...
						    <li class="breadcrumb-item"><a onclick="load_page('process/adding_process_route_for_po_rework.php')">Adding Process Route for PO</a></li>
						  </ol>
			    </nav>
			    
				<form class="form-horizontal" action="" style="margin-top:10px;" name="adding_process_route_for_po_rework_form" id="adding_process_route_for_po_rework_form">
                        ...
                        <table id="process_adding_table" class="table table-striped table-bordered" style="padding:0px; margin:0px;">
                             ...
                             <tbody>
                              ...
                              <tr id='row_for_process_01'>
                                 ...
                                 <td>
                                 	<select  class="form-control" id="process_or_rework_1" name="process_or_rework_1">
											<option value="process" select="selected">Process</option>
											<option value="re-work" selected>re-work</option>
								   </select>
                                 </td>
                               ...
                               <tr>
								...
								<select  class="form-control" id="process_name_2" name="process_name_2">
                                 ...
                                 <td>
                                 	<select  class="form-control" id="process_or_rework_2" name="process_or_rework_2">
                               ...
                               <tr>
								...
								<select  class="form-control" id="process_name_3" name="process_name_3">
                                 ...
                                 <td>
                                 	<select  class="form-control" id="process_or_rework_3" name="process_or_rework_3">
                               ...
                               <tr>
								...
								<select  class="form-control" id="process_name_4" name="process_name_4">
                                 ...
                                 <td>
                                 	<select  class="form-control" id="process_or_rework_4" name="process_or_rework_4">
                               ...
                               <tr>
								...
								<select  class="form-control" id="process_name_5" name="process_name_5">
                                 ...
                                 <td>
                                 	<select  class="form-control" id="process_or_rework_5" name="process_or_rework_5">
                              ...
                              <tr>
								...
								<select  class="form-control" id="process_name_6" name="process_name_6">
                                 ...
                                 <td>
                                 	<select  class="form-control" id="process_or_rework_6" name="process_or_rework_6">
					...
					<div class="form-group form-group-sm" id='form-group_div_for_submit_button'>
								<div class="col-sm-offset-2 col-sm-5">
									<button type="button" class="btn btn-primary" onClick="sending_data_of_adding_process_route_for_po_rework_form_for_saving_in_database()">Submit</button>
        ...
        <div class="panel panel-default" id="adding_process_route_for_po_rework_list">
             ...
             <div class="form-group form-group-sm" id="form-group_for_test_method_name">
					         ...
					         <table id="datatable-buttons" class="table table-striped table-bordered">
					            ...
					            <?php 
					                            $s1 = 1;
					                            $sql_for_process_route = "SELECT * FROM adding_process_route_for_po_rework ORDER BY row_id ASC";
					                            ...
					                            { 
					                             ...
					                             $sql_for_po = "SELECT * FROM po_details where po_id='$po_id' and po_details_id='$po_details_id'";
