...
function travel_card_id_change(travel_card_id)
{
	$.ajax({
 			...
 			/*	po_number = po_number + '?fs?' + po_id;*/
 				 ...
 				 $.ajax({
									 		url: 'process/returning_rework_process_name.php',
									 		dataType: 'text',
									 		type: 'post',
									 		contentType: 'application/x-www-form-urlencoded',
 ...
 function sending_data_of_travel_card_creation_form_for_saving_in_database()
 {
	...
	{*/
		  	 ...
		  	 $.ajax({
			 		url: 'process/rework_wise_travel_card_info_saving.php',
			 		dataType: 'text',
			 		type: 'post',
			 		contentType: 'application/x-www-form-urlencoded',
 ...
 function sending_data_for_delete(po_id)
 {
       ...
       var url_encoded_form_data = 'po_id='+po_id;
		  	 ...
		  	 $.ajax({
			 		url: 'process/rework_deleting.php',
			 		dataType: 'text',
			 		type: 'post',
			 		contentType: 'application/x-www-form-urlencoded',
			 		data: url_encoded_form_data,
				...
				<nav aria-label="breadcrumb">
					  <ol class="breadcrumb">
					    <li class="breadcrumb-item active" aria-current="page">Home</li>
					     <li class="breadcrumb-item"><a onclick="load_page('process/rework_wise_travel_card.php')">Add Travel Card Info</a></li>
					  </ol>
				 </nav>
...
<!-- 
					...
					<div class="form-group form-group-sm" id="form-group_for_process_quantity">
							<label class="control-label col-sm-3" for="process_quantity" style="color:#00008B;">After Process Quantity</label>
							<div class="col-sm-5">
				...
				<div><label class="form-control">Raw Material</label> </div>
				    ...
				    <div><label class="form-control">Process Information</label> </div>
						...
						<div class="form-group form-group-sm" id="form-group_for_process_wastage">
	                        <label class="control-label col-sm-3" for="process_wastage" style="color:#00008B;"> Wastage</label>
	                        <div class="col-sm-5">
	                                         
	                                         <input type="text" class="form-control" id="process_wastage" name="process_wastage" value="" >
