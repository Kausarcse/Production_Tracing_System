...
$color = $spiltted_data[2];
$finish_width_in_inch = $spiltted_data[3];

$sql = "select DISTINCT * from adding_process_to_version where pp_number = '$pp_number' and version_id = '$version_id' and color = '$color' and finish_width_in_inch = '$finish_width_in_inch' ";
							...
							<label><span id="show"></span></label>
							    ...
							    <?php 
							                    /* for pp number id*/
												 ...
												 $result_for_pp= mysqli_query($con,$sql_for_pp) or die(mysqli_error());
					  ...
					  <div class="col-sm-7"> <!-- This will hold table in the form -->
                        ...
                        <table id="process_adding_table" class="table table-striped table-bordered" style="padding:0px; margin:0px;">
                             ...
                             <tbody>
                               ...
                               <?php 
                               		/* for process*/
									 $sql_for_process = "select * from adding_process_to_version where pp_number = '$pp_number' and version_id = '$version_id' and color = '$color' and finish_width_in_inch = '$finish_width_in_inch'";
									 ...
									 while( $row_for_process = mysqli_fetch_array( $result_for_process))
									 {
									 	 ...
									 	 <tr>
			                                 ...
			                                 <td align="center" style="padding-left:0px; padding-right:0px;">
			                                      ...
			                                      <button type="button" class="btn-primary" style="padding-top:1px;" onClick="adding_specific_row_of_process_adding_table(<?php echo $sl; ?>)">Add</button>
			                                      <button type="button" class="btn-primary" style="padding-top:1px;" onClick="deleting_specific_row_of_process_adding_table(<?php echo $sl; ?>)">Del</button>
			                              	</td>
			                              <tr>
