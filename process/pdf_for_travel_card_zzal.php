...
$pdf->Cell(50,9,"Section Name".$pdf->SetFillColor(255,204,204),"1","0",'C',true);  
$pdf->Cell(50,9,"CTN Quantity","1","0",'C'); 
...
$select_sql_for_process="select distinct acprfp.process_name
    ...
    {
        $pdf->Cell(45,9,$row_for_for_process['process_name'].$pdf->SetFillColor(255,204,204),"1","0",'C',true);
        $pdf->Cell(5,9," : ","1","0","C");  
        $pdf->Cell(50,9,"","1","0",'C'); 
        $pdf->Cell(50,9,"","1","0",'C');  
        $pdf->SetFillColor(0,0,0);  
