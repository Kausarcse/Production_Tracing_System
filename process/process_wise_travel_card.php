			       ...
			       if(validate != false)
				   {
					  	 ...
					  	 $.ajax({
						 		...
						 		success: function( data, textStatus, jQxhr )
						 		{
						 				...
						 				document.getElementById('po_details').value = '';
						 				document.getElementById('customer_name').value = '';
						 				document.getElementById('buyer_name').value = '';
						 				document.getElementById('buyer_id').value = '';
						 				document.getElementById('po_order_received_date').value = '';
						 				document.getElementById('product_delivery_date').value = '';
						 				document.getElementById('responsible_person').value = '';
						 				document.getElementById('po_quantity').value = '';
						 				document.getElementById('product_category').value = '';
						 				document.getElementById('order_type').value = '';


						 				document.getElementById('measurement_of_carton_length').value = '';
						 				document.getElementById('measurement_of_carton_width').value = '';
						 				document.getElementById('measurement_of_cartoon_height').value = '';
						 				document.getElementById('measurement_of_cartoon_ply').innerHTML = '';


						 				document.getElementById('paper_type_linear').value = '';
						 				document.getElementById('paper_type_medium').value = '';
						 				document.getElementById('paper_type_medium_1').value = '';
						 				document.getElementById('paper_type_medium_2').value = '';
						 				document.getElementById('paper_type_linear_1').value = '';

						 				document.getElementById('flute_type').innerHTML = '';
						 				document.getElementById('printing_status').innerHTML = '';
						 				document.getElementById('dye_cutting').innerHTML = '';


						 				document.getElementById('carton_quantity').value = '';
						 				document.getElementById('ratio').value = '';
						 				document.getElementById('board_quantity').value = '';
						 				document.getElementById('cutter_size').value = '';
						 				document.getElementById('roll_size').value = '';
						 				document.getElementById('cutting_ratio').value = '';
						 				document.getElementById('score_or_creez_size').value = '';
						 				document.getElementById('score_or_creez_size_1').value = '';
						 				document.getElementById('score_or_creez_size_2').value = '';
						 				document.getElementById('slotting_size').value = '';
						 				document.getElementById('slotting_size_1').value = '';
						 				document.getElementById('slotting_size_2').value = '';
						 				document.getElementById('slotting_size_3').value = '';


						 				document.getElementById('liner_consumption_calc').value = '';
						 				document.getElementById('media_consumption_calc').value = '';
						 				document.getElementById('sqm_consumption_calc').value = '';
						 				document.getElementById('total_consumption').value = '';


						 				document.getElementById('before_process_quantity').value = '';
						 				document.getElementById('process_quantity').value = '';
						 		},
						 		error: function( jqXhr, textStatus, errorThrown )
						 		{
						 				//console.log( errorThrown );
					 ...
					 <div class="form-group form-group-sm" id="form-group_for_travel_card_id">
								...
								<div class="col-sm-5">
									...
									<select  class="form-control for_auto_complete" id="travel_card_id" name="travel_card_id" onchange="travel_card_id_change(this.value)"> 
													<option value="select">Select Travel Card</option>
													<?php 
				    ...
				    <div><label class="form-control">Process Information</label> </div>
						...
						<div class="form-group form-group-sm" id="form-group_for_before_process_quantity" id="before_process_quantity">
								...
								<div class="col-sm-5">
	                                      ...
	                                      <input type="text" class="form-control" id="before_process_quantity" name="before_process_quantity" value="" readonly>
