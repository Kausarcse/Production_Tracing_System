...
/*for footer Section*/
    ...
    $pdf->Cell(120,5,"Reported By:____________________","0","0",'l'); 
    $pdf->Cell(90,5,"Checked By:____________________","0","1",'l');
    $pdf->SetFont('Arial','B',10);
    ...
    while($row_for_for_process=mysqli_fetch_assoc($result_for_process))
    {
        ...
        $pdf->Cell(40,4,$row_for_for_process['process_quantity'],"1","0",'C');  
        $pdf->Cell(40,4,$row_for_for_process['balance'],"1","0",'C');  
        $pdf->Cell(40,4,"","1","0",'C'); 
        $pdf->Cell(35,4,"","1","1",'C');
    }
